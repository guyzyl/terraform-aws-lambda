...
def build_command(args):
    ...
    with ZipWriteStream(filename, compresslevel=args.zip_file_compresslevel) as zs:
        bpm = BuildPlanManager(args, log=log)
...
def add_hidden_commands(sub_parsers):
    ...
    def zip_cmd(args):
        ...
        with ZipWriteStream(args.zipfile, compresslevel=args.compresslevel) as zs:
    ...
    p.add_argument('-c', '--compresslevel', type=int,
                   help='The Python zipfile compresslevel, 0 to 9')
...
def args_parser():
    ...
    p.add_argument('-c', '--compresslevel',
                   type=int, dest='zip_file_compresslevel',
                   help='The Python zipfile compresslevel, 0 to 9')
